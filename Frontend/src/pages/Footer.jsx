...
const Footer = () => {
  return (
    <footer className="bg-gradient-to-r from-[#0A0A0A] via-[#2C2C2C] to-[#0A0A0A] text-white text-sm py-16 w-full static shadow-xl">
      <div className="px-10">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-12 text-center md:text-left">
          ...
          <div className="bg-[#1A1A1A] p-6 rounded-lg shadow-2xl transform transition-all hover:scale-105 hover:shadow-2xl hover:bg-[#333]">
            <h3 className="font-semibold mb-4 text-xl text-gray-200 tracking-wide transition-all transform hover:text-indigo-500">About</h3>
          ...
          {/* Community Section */}
          <div className="bg-[#1A1A1A] p-6 rounded-lg shadow-2xl transform transition-all hover:scale-105 hover:shadow-2xl hover:bg-[#333]">
            <h3 className="font-semibold mb-4 text-xl text-gray-200 tracking-wide transition-all transform hover:text-indigo-500">Community</h3>
            <ul className="space-y-2">
          ...
          {/* Policies Section */}
          <div className="bg-[#1A1A1A] p-6 rounded-lg shadow-2xl transform transition-all hover:scale-105 hover:shadow-2xl hover:bg-[#333]">
            <h3 className="font-semibold mb-4 text-xl text-gray-200 tracking-wide transition-all transform hover:text-indigo-500">Policies</h3>
            <ul className="space-y-2">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h3 className="font-semibold mb-4 text-xl text-gray-200 tracking-wide transition-all transform hover:text-indigo-500">Follow Us</h3>
