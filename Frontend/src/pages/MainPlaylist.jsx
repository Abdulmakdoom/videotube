        ...
        <div className="flex flex-col md:flex-row bg-[#0A0A0A] text-white h-auto md:h-screen p-4 mt-20">
          ...
          <div className="w-full md:w-3/4 h-auto overflow-y-auto scroll-smooth scrollbar-thin scrollbar-thumb-gray-600 scrollbar-track-gray-800 mt-4 md:mt-0">
            <div className="mt-4 md:mt-0 md:ml-4">
              <div className="bg-[#212121] rounded-2xl h-40 w-full mb-6 relative">
              ...
              {playlistData?.videos.map((video, index) => (
                  <div key={video?._id} className="flex flex-col sm:flex-row items-start gap-4 hover:bg-[#212121] ml-6 hover:rounded-2xl transition-all duration-300 h-full sm:h-45">
                    <Link to={`/home/videos/${video?._id}`} >
                      <div className="relative rounded-lg w-full sm:w-60 md:w-72 lg:w-80 h-40 shadow-lg  sm:mb-0 sm:mt-0 bg-[#0A0A0A]">
                        <div className="relative w-full h-full">
                          <img
                            src={video?.thumbnail}
                            alt={video?.title}
                            className="absolute top-0 left-0 w-full h-full object-cover rounded-md border-none"
                          />
                        </div>
                    ...
                    <Link to={`/home/videos/${video?._id}`}>
                      <h3 className="text-lg sm:text-xl font-semibold mt-2">{video?.title}</h3>
